package com.example.manage.laundry.ui.staff.screen.payment
...
import com.example.manage.laundry.ui.staff.screen.payment.components.PaymentOrderList
    ...
    LaunchedEffect(updateOrderState) {
        when (updateOrderState) {
            is StaffViewModel.UpdateOrderState.Success -> {
                ...
                paymentViewModel.loadDeliveryOrders()
            }
    ...
    Surface(
        ...
        when {
            ...
            uiState.error != null -> Column(
                ...
                Spacer(modifier = Modifier.height(16.dp))
                TextButton(onClick = { paymentViewModel.loadDeliveryOrders() }) {
                    Text("Thử lại")
                }
            }
            ...
            uiState.orders.isEmpty() -> Column(
                ...
                Text(
                    text = "Không có đơn hàng nào cần thanh toán",
                    style = MaterialTheme.typography.titleMedium
                )
                Spacer(modifier = Modifier.height(16.dp))
                TextButton(onClick = paymentViewModel::loadDeliveryOrders) {
