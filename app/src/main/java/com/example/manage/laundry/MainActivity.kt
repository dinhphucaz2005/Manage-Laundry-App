...
import com.example.manage.laundry.ui.system_admin.SystemAdminActivity
        ...
        setContent {
            ManageLaundryAppTheme {
                LaundryAppNavigation(
                    ...
                    onNavigateSystemAdminActivity = {
                        val intent = Intent(this@MainActivity, SystemAdminActivity::class.java)
                        startActivity(intent)
                    }
                )
            }
